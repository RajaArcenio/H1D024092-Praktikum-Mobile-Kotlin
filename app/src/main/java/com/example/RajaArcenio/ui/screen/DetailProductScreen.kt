...
fun DetailProductScreen(productId: Int, navController: NavController?) {
    ...
    StatelessDetailProduct(
        ...
        onAddToCartClick = { Toast.makeText(context, "Beli $quantity: ${product?.name}", Toast.LENGTH_SHORT).show() }
    )
}
    ...
    Scaffold(
        ...
        if (isLoading) {
            ...
            Column(modifier = Modifier
                ...
                Image(painter = painterResource(id = imageRes), contentDescription = null, modifier = Modifier.fillMaxWidth().height(280.dp))
